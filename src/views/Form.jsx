...
function Form() {
    ...
    const getPrediction = async () => {
        try {
            let response = await axios.get(`http://116.193.190.68:5000/covidtest/
                ${[[ form.cough,form.fever, 
                    form.sore_throat, 
                    form.shortness_of_breath, 
                    form.head_ache, form.age, 
                    form.gender, 
                    form.indication, 
                    form.result ]]}`)
    ...
    /* const getPrediction = () => {
        let url = `http://116.193.190.68:5000/covidtest/${[[ form.cough,form.fever, form.sore_throat, form.shortness_of_breath, form.head_ache, form.age, form.gender, form.indication, form.result ]]}`
        fetch(url, {
            method: 'GET', 
            mode: 'no-cors',
            headers: {
